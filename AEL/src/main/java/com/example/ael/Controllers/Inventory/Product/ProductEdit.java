...
public class ProductEdit {
    ...
    private boolean saveRecord() {
        ...
        String addQuery = "UPDATE Products SET "
    ...
    private void populateFields() {
        String query = "SELECT * FROM Products INNER JOIN Categories ON Categories.CategoryID=Products.CategoryID WHERE ProductID="+prodID+";";
        Connection connection = DatabaseManager.connect();
        try{
            ResultSet rs = connection.prepareStatement(query).executeQuery();
            while (rs.next()) {
                text_title.setText(rs.getString("Title"));
                text_unitCost.setText(rs.getString("UnitCost"));
                text_weight.setText(rs.getString("Weight"));
                text_minLevel.setText(rs.getString("MinLevel"));
                selectCombo(rs.getString("CategoryName"),combo_category);
            }
        } catch (SQLException e){
